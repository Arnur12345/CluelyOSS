  ...
  public async takeScreenshot(
    ...
    try {
      ...
      if (this.view === "queue") {
        ...
        // Verify file was actually created (screencapture can fail silently on macOS without permissions)
        if (!fs.existsSync(screenshotPath)) {
          throw new Error("Screenshot file was not created. Check Screen Recording permission in System Settings > Privacy & Security.")
        }
