...
export function initializeIpcHandlers(appState: AppState): void {
  ...
  ipcMain.handle("reset-queues", async () => {
    try {
      ...
      appState.processingHelper.getLLMHelper().clearConversationHistory()
      console.log("Screenshot queues and conversation history have been cleared.")
      return { success: true }
    } catch (error: any) {
  ...
  ipcMain.handle("get-available-gemini-models", async () => {
    try {
      const llmHelper = appState.processingHelper.getLLMHelper();
      return llmHelper.getAvailableGeminiModels();
    } catch (error: any) {
