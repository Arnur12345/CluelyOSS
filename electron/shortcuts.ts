...
export class ShortcutsHelper {
  ...
  public registerGlobalShortcuts(): void {
    ...
    globalShortcut.register("CommandOrControl+R", () => {
      ...
      // Clear both screenshot queues and conversation history
      this.appState.clearQueues()
      this.appState.processingHelper.getLLMHelper().clearConversationHistory()

      console.log("Cleared queues and conversation history.")
